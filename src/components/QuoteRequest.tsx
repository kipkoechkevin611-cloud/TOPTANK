...
export default function QuoteRequest() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    openWhatsAppOrder(whatsappNumber, {
      ...
      capacity: formData.tankCapacity,
      price: 'To be quoted',
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Fill out the form below and we'll get back to you with a customized quote for your water storage needs.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">toptank662@gmail.com</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Tank Capacity</label>
                    <select
                      name="tankCapacity"
                    ...
                    >
                      ...
                      <option value="1000L">1,000L</option>
                      <option value="2000L">2,000L</option>
                      <option value="3000L">3,000L</option>
                      <option value="5000L">5,000L</option>
                      <option value="10000L">10,000L</option>
                      <option value="15000L">15,000L</option>
                      <option value="24000L">24,000L</option>
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-4 px-6 rounded-xl font-semibold hover:from-green-700 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
