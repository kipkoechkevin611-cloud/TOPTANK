        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <button
              ...
              disabled={!inStock}
              className="flex-1 bg-blue-600 text-white py-3 px-4 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
            ...
            <button
              ...
              className="flex-1 bg-green-600 text-white py-3 px-4 rounded-xl font-semibold hover:bg-green-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:outline-none"
