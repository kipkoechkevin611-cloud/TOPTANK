    ...
    <>
      ...
      <div className="fixed bottom-20 right-4 z-50 flex flex-col gap-3 md:hidden">
        <a
          ...
          className="w-14 h-14 bg-green-600 rounded-full shadow-2xl flex items-center justify-center hover:bg-green-700 transition-colors"
        ...
        <a
          ...
          className="w-14 h-14 bg-blue-600 rounded-full shadow-2xl flex items-center justify-center hover:bg-blue-700 transition-colors"
          aria-label="Call us"
        >
