          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <motion.h1
                ...
                className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-8 bg-gradient-to-r from-white via-blue-100 to-cyan-200 bg-clip-text text-transparent"
              >
              ...
              <motion.p
                ...
                className="text-base md:text-lg text-blue-100 mb-12 leading-relaxed font-light"
              >
              ...
              >
                ...
                <a href="tel:+254739447779" className="font-semibold hover:text-blue-200 transition-colors bg-blue-600/30 px-4 py-2 rounded-full">0739 447 779</a>
              </motion.div>
